...
# Copyright notice
The method implememnted by this code is **patent pending**, and currently we do not offer any license associated with this code. However, non-commercial use of this code for research is permitted if the following paper is cited: 
